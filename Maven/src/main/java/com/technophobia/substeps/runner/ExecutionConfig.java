...
public class ExecutionConfig {
    ...
    /**
     * If a scenario (and therefore a feature) that has this tag fails to pass, then the build will not fail. This is useful for scenarios where tests are written and are included in a CI build in
     * advance of completed functionality, this allows the build and therefore maven releases to succeed. Over the course of a project this list should be reduced as confidence in the delivery grows.
     * Format is the same for <tags>
     *
     * @parameter
     */
    ...
    /**
     * Defaults to true, if false, Substeps will use the nonStrictKeywordPrecedence to look for alternate expressions if an exact match can’t be found. Useful for porting Cucumber features.
     *
     ...
     * <param>com.technophobia.substeps.MySetup<param>. By default the initialisation classes associated with the step implementations will be used.
     *
     * @parameter
     */
